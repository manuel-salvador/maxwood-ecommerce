This is a [Next.js](https://nextjs.org/) + [TailwindCSS](https://tailwindcss.com/) project bootstrapped with [`create-manu-app`](https://www.npmjs.com/package/create-manu-app).
